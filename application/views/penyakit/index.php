          ...
          <div class="card card-secondary">
			...
			<form action="" method="POST">
              <div class="form-group">
			  	<label for="id_penyakit_tambah">ID </label>
                <input type="text" name="id_penyakit" value="<?php echo $id_unik; ?>" class="form-control" id="id_penyakit_tambah" readonly>
              </div>
              <div class="form-group">
                <label for="nama_penyakit_tambah">Nama Penyakit Menular</label>
                <input type="text" id="nama_penyakit_tambah" class="form-control" name="nama_penyakit">
              </div>
